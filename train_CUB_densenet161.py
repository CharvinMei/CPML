...
from model_Densenet161 import CPML as model
...
def main():
    ...
    epochs = 128
    best_acc = 0.0
    save_path = './result/CUB200/best_model_densenet161_CPML.pth'
    ...
    for epoch in range(epochs):
        ...
        plt.xlabel("epochs")
        plt.ylabel("Acc")
        plt.title('Densenet161 in CUB200')
        ...
        plt.grid()
        plt.legend()
        plt.savefig("./result/CUB200/Acc_densenet161_CPML.jpg")
        ...
        plt.grid()
        plt.legend()
        plt.savefig("./result/CUB200/Loss_densenet161_CPML.jpg")
